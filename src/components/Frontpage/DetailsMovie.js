...
const DetailsMovie = (props) => (
  <div className={`item_${props.movie.id}`}>
    <div className='image_content'>
      <a id={`movie_${props.movie.id}`} className="result" href={`/movie/${props.movie.id}`} title={props.movie.title} >
        <img className='poster' src={`https://image.tmdb.org/t/p/w185_and_h278_bestv2${props.movie.backdrop_path}`} alt={props.movie.title}/>
      </a>
      <div className='info'>
